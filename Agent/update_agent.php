...
if (isset($_POST['search_agent']))
{
	...
	$mquery = "SELECT id_agent,im_agent,classe_agent,nom_agent,prenom_agent,date_naiss_agent
	,adresse_agent,tel_agent,nom_fonct FROM agent where im_agent='$num_agent' ";
...
<center>
<div class="container">
<div style="width:1000px;height:510px;overflow:auto;padding:3px;">
	<table id="monTableau" name="monTableau" class="letableau01" style="font-size:13px;text-align:center;">
	  <tr>
		  <th style="padding-left:15px; padding-right:15px;">ID</th>
		  <th>Immatriculation</th>
		<th>Nom</th>
		<th>Prénoms</th>
		<th style="padding-left:35px; padding-right:35px;">Grade</th>
		...
		<div class="modals-close closebtn" title="Fermer la fenêtre">x</div><br>
                ...
                <br>
					...
					<select class="linput04b" id="classe_agent" name="classe_agent" style="margin-top:9px;width:185px;">
						...
						<option value="2° classe 1° Echelon">2° classe 1° Echelon</option>						
						<option value="2° classe 2° Echelon">2° classe 2° Echelon</option>
                        <option value="3° classe 3° Echelon">3° classe 3° Echelon</option>
                        <option value="1° classe 1° Echelon">1° classe 1° Echelon</option>
                        <option value="1° classe 2° Echelon">1° classe 2° Echelon</option>
                        <option value="1° classe 3° Echelon">1° classe 3° Echelon</option>
						<option value="Principal 1° Echelon">Principal 1° Echelon</option>
						<option value="Principal 2° Echelon">Principal 2° Echelon</option>
						<option value="Principal 3° Echelon">Principal 3° Echelon</option>
						<option value="Classe Exceptionnelle 1° Echelon">Classe Exceptionnelle 1° Echelon</option>
						<option value="Classe Exceptionnelle 2° Echelon">Classe Exceptionnelle 2° Echelon</option>
                    </select>
					<select name="classe_agent" id="classe_agent" style="padding-left: 5px;padding-top: 4px;padding-bottom: 4px;border-radius:9px;">
						<option selected disabled style="color:white;background-color:grey;">Autre</option>
...
<?php 
	include 'updt_agent.php';
?>

<!--AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA-->
<div class="modals2_bg" id="modals2">
	<div class="modals2-content">
	<a href="agents.php"><div class="close2btn" title="Fermer la fenêtre">x</div><br></a>

                <form action="" method="POST">
                <p style="font-size:30px;color:white;"><b>MODIFIER UN AGENT</b></p>
                <p style="font-size:13px;color:white;"><i class="fas fa-exclamation-triangle"></i><i> Tous les champs sont obligatoires </i></p>
                <br>
					<input type="hidden" id="id_agent" value=<?php echo $id; ?> name="id_agent">
                    <input type="text" class="linput04" id="im_agent" value="<?php echo $im_agent; ?>" name="im_agent" placeholder="N° d'immatriculation" autocomplete="off" required style="margin-top:9px;">
                    <br>
                    <p><input type="text" class="linput04" id="nom_agent" value="<?php echo $nom_agent; ?>" name="nom_agent" placeholder="Nom" required style="margin-top:9px;" autocomplete="off" maxlength=40></p>
                    <p><input type="text" class="linput04" id="prenom_agent" value="<?php echo $prenom_agent; ?>" name="prenom_agent" placeholder="Prénoms" required style="margin-top:9px;" autocomplete="off" maxlength=60></p>
                    <span style="color:white;">Grade et Echelon : </span>
					<select class="linput04b" id="classe_agent" name="classe_agent" style="margin-top:9px;width:185px;">
						<option selected style="color:white;background-color:grey;"><?php echo $classe_agent; ?></option>
						<option value="Stagiaire">Stagiaire</option>
					...
					<span style="color:white;">ELD : </span>           
					<select class="linput04b" id="eld_agent" name="eld_agent" style="margin-top:9px;width:340px;">						
						<option selected value="MJ 00" selected style="color:white;background-color:grey;"><?php echo $eld_agent; ?></option>
						<option value="MJ 00">MJ 00</option>
						<option value="MJ 10">MJ 10</option>
						<option value="MJ 20">MJ 20</option>
						<option value="MJ 30">MJ 30</option>
						<option value="MJ 40">MJ 40</option>
					...
					<span style="color:white;">Corps : </span>           
					<select class="linput04b" id="corps_agent" name="corps_agent" style="margin-top:9px;width:325px;">
					<option selected style="color:white;background-color:grey;"><?php echo $corps_agent; ?></option>
						<option value="Sous-opérateur">Sous-opérateur</option>
						<option value="Opérateur">Opérateur</option>
						<option value="Encadreur">Encadreur</option>
						<option value="Technicien Supérieur">Technicien Supérieur</option>
                    ...
                    <p>
                    <span style="color:white;">Date de naissance : </span>
                    <input type="date" class="linput04c" id="date_naiss_agent" value="<?php echo $date_naiss_agent; ?>" name="date_naiss_agent" placeholder="Date de naissance" required style="margin-top:9px;width:240px;"></p>
                    <p><input type="text" class="linput04" id="adresse_agent" value="<?php echo $adresse_agent; ?>" name="adresse_agent" placeholder="Adresse" required style="margin-top:9px;" autocomplete="off"></p>
                    <p><input type="number" class="linput04" id="tel_agent" value="<?php echo $tel_agent; ?>" name="tel_agent" placeholder="Téléphone" required style="margin-top:9px;" autocomplete="off"></p>
                    <p><input type="text" class="linput04" id="nom_fonct" value="<?php echo $nom_fonct; ?>" name="nom_fonct" placeholder="Fonction" required style="margin-top:9px;"></p>
                    <br>
                    <button type="submit" id="update_agent" name="update_agent" class="btn_009" style="color:white;"><b>METTRE A JOUR</b></button>
                    <a href="agents.php"><input type="button" name="" id="" value="FERMER" style="color:white;font-weight:bold;" class="btn_003"></a>
                    <br><br>                
                </form>
...
<script defer> 
//MODAL MANOKATRA BOUTON MODIFIER
var modal2Btns = document.querySelectorAll(".modals2-open");

modal2Btns.forEach(function(btn2){
    btn2.onclick = function(){
        var modals2 = btn2.getAttribute("data-modal");

        document.getElementById(modals2).style.display="block";
    };
});

var close2Btns = document.querySelectorAll(".modals2-close");

close2Btns.forEach(function(btn2){
    btn2.onclick = function(){
        var modals2 = (btn2.closest(".modals2_bg").style.display = "none");        
    };
});


window.onclick = function(e){
    if (e.target.className === "modals2_bg"){
